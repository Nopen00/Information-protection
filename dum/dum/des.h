...
typedef enum DesOrder_ { encipher, decipher } DesOrder;
...
static const int ip[64]				/* ip permutation */
...
static const int fp[64]				/* fp (ip inverse) permutation */
...
static const int e[48] = {			/* expansion operation matrix   */
	32,  1,  2,  3,  4,  5,
	 4,  5,  6,  7,  8,  9,
	 8,  9, 10, 11, 12, 13,
	12, 13, 14, 15, 16, 17,
...
static const int pc1[56]				/* pc1 table (key) */
= {	57, 49, 41, 33, 25, 17,  9,
	 1, 58, 50, 42, 34, 26, 18,
	10,  2, 59, 51, 43, 35, 27,
	19, 11,  3, 60, 52, 44, 36,
...
static const int rotate[]			   /* number left rotations of pc1 (key) */
= {	1,2,4,6,8,10,12,14,15,17,19,21,23,25,27,28	};

static const int pc2[48]				/* pc2 table (key) */
= {	14, 17, 11, 24,  1,  5,
	 3, 28, 15,  6, 21, 10,
	23, 19, 12,  4, 26,  8,
	16,  7, 27, 20, 13,  2,
...
static const char s_box[8][64]		/* 48->32 bit compression tables*/
= {					/* S[1]			 */
...
static const int p32[32]			/* 32-bit permutation function */
= {	16,  7, 20, 21,
	29, 12, 28, 17,
	 1, 15, 23, 26,
	 5, 18, 31, 10,
